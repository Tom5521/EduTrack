...
func (DarkBlue) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x1, G: 0x15, B: 0xfc, A: 0x39}
...
func (DarkBlue) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (DarkBlue) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (DarkBlue) Size(s fyne.ThemeSizeName) float32 {
	switch s {
