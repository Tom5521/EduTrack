...
type SimpleRed struct{}

func (SimpleRed) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x28, G: 0x28, B: 0x28, A: 0xdb}
	case theme.ColorNameButton:
		return color.NRGBA{R: 0x1, G: 0x1, B: 0x1, A: 0x3d}
...
func (SimpleRed) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (SimpleRed) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (SimpleRed) Size(s fyne.ThemeSizeName) float32 {
	switch s {
