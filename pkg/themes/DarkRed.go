...
func (DarkRed) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0x1c, G: 0x0, B: 0x0, A: 0xff}
...
func (DarkRed) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (DarkRed) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (DarkRed) Size(s fyne.ThemeSizeName) float32 {
	switch s {
